...
xadet
apt install python3-pip python-pip wget curl clang git net-tools apt-utils unzip pkg-config libfreetype6-dev python-bs4 tightvncserver php lxde-core metasploit-framework -y
